...
<?php if ($error): ?>
    <div class="error-box reveal"><?= e($error) ?></div>
<?php endif; ?>

<?php if ($success): ?>
    <div class="success-box reveal"><?= e($success) ?></div>
<?php endif; ?>
        ...
        <article class="panel security-card reveal fade-up">
            ...
            <details class="recovery-details" id="recovery" open>
                ...
                <?php if (!empty($user['security_question'])): ?>
                    ...
                    <?php if ($revealMessage): ?>
                        <div class="success-box compact-message"><?= e($revealMessage) ?></div>
                    <?php endif; ?>
