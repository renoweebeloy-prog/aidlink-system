    ...
    <div class="auth-form">
        ...
        <div class="auth-actions">
            <form method="POST">
                ...
                <button class="small-button <?= $mode === 'previous' ? '' : 'secondary' ?>" type="submit">
                    Previous Password
                </button>
            </form>
            ...
            <form method="POST">
                ...
                <button class="small-button <?= $mode === 'question' ? '' : 'secondary' ?>" type="submit">
                    Recovery Question
                </button>
            </form>
        </div>
        ...
        <?php if ($mode === 'question'): ?>
            ...
            <?php if (!$question): ?>
                <form method="POST" autocomplete="off">
                    ...
                    <button class="button" name="load_question" type="submit">
                        Continue
                    </button>
                </form>
            ...
            <?php else: ?>
                <form method="POST" autocomplete="off">
                    ...
                    <button class="button" name="reset_question" type="submit">
                        Update Password
                    </button>
                </form>
            <?php endif; ?>
        ...
        <?php else: ?>
            ...
            <form method="POST" autocomplete="off">
                ...
                <button class="button" name="reset_previous" type="submit">
                    Update Password
                </button>
            </form>
