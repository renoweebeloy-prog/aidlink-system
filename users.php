...
<section class="page-head reveal">
    <div>
        ...
        <p class="lead">
            Create coordinator or volunteer accounts and review registered recipients.
        </p>
    </div>
</section>
...
<section class="panel reveal">
    ...
    <form class="grid-form" method="POST" autocomplete="off">
        ...
        <button class="button create-account-button" type="submit">
            Create Account
        </button>
            ...
            <tbody>
                ...
                <?php foreach ($users as $account): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="pill role-badge">
                                <?= e(role_label($account['role'] ?? 'citizen')) ?>
                            </span>
                        </td>
