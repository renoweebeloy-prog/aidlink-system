...
$messageCount = $user ? Messenger::unreadCount((int)$user['id']) : 0;
...
function icon_svg(string $name): string
{
    $icons = [
        ...
        'bell' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>',

        'theme' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3a9 9 0 1 0 9 9 7 7 0 0 1-9-9Z"></path></svg>',
    ];
...
<body class="<?= $user ? 'app-page' : 'auth-page' ?>">
    ...
    <?php if ($user): ?>
        ...
        <div class="top-actions">
            ...
            <a class="icon-button" href="messenger.php">
            ...
            <a class="icon-button" href="notifications.php">
